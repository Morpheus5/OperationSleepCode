function [Av_Size,mean_Size,Av_IEI,mean_IEI,StDev_IEI,Time] = Byrons_Burst_Analysis(Av_Data,window,maxThreshold,Fs)
%Burst_Analysis.m
...
% save('Spontaneous_Data_Averages3.mat','Av_Data','Av_IEI','Av_Size','mean_Size','mean_IEI','StDev_IEI');
save('Spontaneous_Data_Averages3.mat','Av_Data','Av_IEI','Av_Size');
end
